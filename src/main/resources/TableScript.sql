...
insert into customer values (1001,'steven@th.com', 'Steven Martin', sysdate()-interval 7476 day);
insert into customer values (1002,'kevin@th.com', 'Kevin Nelson', sysdate()-interval 11374 day);
insert into customer values (1003,'john@th.com', 'John Matric',sysdate()-interval 12344 day);
insert into customer values (1004,'chan@th.com', 'Chan Mathew', sysdate()-interval 10344 day);
insert into customer values (1005,'jill@th.com', 'Jill Mathew', sysdate()-interval 11374 day);
